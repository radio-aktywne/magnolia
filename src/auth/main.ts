...
export const authConfig = {
  ...
  cookies: {
    callbackUrl: {
      ...
      options: {
        domain: process.env.MAGNOLIA__COOKIES__DOMAIN || undefined,
      },
    },
    csrfToken: {
  ...
  debug: (process.env.MAGNOLIA__DEBUG || "true") === "true",
  pages: {
    error: "/auth/error",
    newUser: "/auth",
    signIn: "/auth/login",
  ...
  secret: splitSecrets(process.env.MAGNOLIA__SECRETS__AUTH || "secret"),
  session: {
